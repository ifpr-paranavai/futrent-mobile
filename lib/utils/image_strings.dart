...
class TImages {
  ...
  static String cartAnimation =
      'assets/images/animations/lady-adding-productin-cart-animation.json';
  ...
  static String packageAnimation =
      'assets/images/animations/98783-packing-in-progress.json';
  ...
  static String securityAnimation =
      'assets/images/animations/67623-security-icon-transparent.json';
  ...
  static String paymentSuccessfulAnimation =
      'assets/images/animations/120978-payment-succesful.json';
  ...
  static String cloudUploadingAnimation =
      'assets/images/animations/cloud-uploading-animations.json';
